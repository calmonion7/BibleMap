...
function GoliathScene({ reduce }) {
  return (
    <g>
      ...
      {/* 시내 — 다섯 매끄러운 돌을 고른 곳(삼상 17:40) */}
      <g style={d(120, reduce)}>
        <path d="M50 53 q8 -2.5 16 0" {...sw(1.3, 0.55)} />
        <path d="M56 51.5 h2" {...sw(1.2, 0.55)} />
        <path d="M62 52 h2" {...sw(1.2, 0.55)} />
      </g>
      <g style={d(240, reduce)}>
        <path d="M52 52.5 h1.5" {...sw(1.2, 0.55)} />
        <path d="M14 52.5 l1 -2 l1 2" {...sw(1.1, 0.45)} />
        <path d="M42 53 l0.8 -1.6 l0.8 1.6" {...sw(1.1, 0.45)} />
      </g>
      <g style={d(360, reduce)}>
        <path d="M78 53 l0.9 -1.8 l0.9 1.8" {...sw(1.1, 0.45)} />
        <path d="M0 20 q18 -5 36 0 t36 0 t36 2" {...sw(1.1, 0.3)} />
        <path d="M18 14 q3 -2 6 0 q3 -2 6 0" {...sw(1.1, 0.3)} />
      </g>
      <g style={d(480, reduce)}>
        <path d="M92 12 q3 -2 6 0 q3 -2 6 0" {...sw(1.1, 0.3)} />
        <circle cx="54" cy="53.5" r="0.55" {...sw(1.4)} />
        <circle cx="56.5" cy="54" r="0.5" {...sw(1.4)} />
      </g>
      <g style={d(600, reduce)}>
        <circle cx="59" cy="53.3" r="0.55" {...sw(1.4)} />
        <circle cx="61.5" cy="54" r="0.5" {...sw(1.4)} />
        <circle cx="51.5" cy="54" r="0.5" {...sw(1.4)} />
      </g>
      <g style={d(720, reduce)}>
        <path d="M10 16 q1.5 -1.5 3 0 q1.5 -1.5 3 0" {...sw(1.1, 0.35)} />
        <path d="M100 14 q1.5 -1.5 3 0 q1.5 -1.5 3 0" {...sw(1.1, 0.35)} />
        <path d="M6 50 q1 -3 3 -3 q1 -3 3 0" {...sw(1.2, 0.5)} />
      </g>
      <g style={d(840, reduce)}>
        <path d="M46 53.3 v-2.5" {...sw(1.1, 0.4)} />
        <path d="M20 53.2 l0.7 -1.4 l0.7 1.4" {...sw(1.1, 0.45)} />
        <path d="M9 52.8 l0.8 -1.6 l0.8 1.6" {...sw(1.1, 0.45)} />
      </g>
      <g style={d(960, reduce)}>
        <path d="M60 12 q2.5 -1.7 5 0 q2.5 -1.7 5 0" {...sw(1.1, 0.3)} />
        <path d="M118 50 q-1 -3 -3 -3" {...sw(1.2, 0.5)} />
        <path d="M108 53 l0.7 -1.4 l0.7 1.4" {...sw(1.1, 0.45)} />
      </g>
      {/* 골리앗 — 다리·팔에 겉·안 두 선으로 부피를 준다(막대기 사지 금지), 몸통은 어깨→허리로 좁아진다.
          이 그룹은 넘어지는 동작(회전)까지만 맡는다 — 전신을 큰 각도로 회전시키면 창·방패·팔다리가
          뭉쳐 읽히므로(task#303 UAT 결함 A) 회전이 멈추는 즉시 아래 쓰러진 자세로 교체 페이드한다. */}
      <g transform={reduce ? 'rotate(-50 103 41)' : undefined} opacity={reduce ? 0 : undefined}>
        {/* 다리 — 겉선(굵게)·안선(부피) */}
        <g style={d(1080, reduce)}>
          <path d="M96 37 l-1 9 l2.5 8" {...sw(2.6)} />
          <path d="M111 37 l1 9 l-2.5 8" {...sw(2.6)} />
          <path d="M95 46 h3.5" {...sw(1.3)} />
        </g>
        <g style={d(1200, reduce)}>
          <path d="M108.5 46 h3.5" {...sw(1.3)} />
          <path d="M99.5 37.5 l-1 8.5 l1.5 7.5" {...sw(1.8)} />
          <path d="M107.5 37.5 l1 8.5 l-1.5 7.5" {...sw(1.8)} />
        </g>
        <g style={d(1320, reduce)}>
          <path d="M96.5 54 h4" {...sw(1.6)} />
          <path d="M107 54 h4" {...sw(1.6)} />
          <path d="M96 50 h2.8" {...sw(1.2)} />
        </g>
        <g style={d(1440, reduce)}>
          <path d="M108.7 50 h2.8" {...sw(1.2)} />
          <path d="M97.5 53 q1 -0.8 2 0" {...sw(1.2)} />
          <path d="M108.5 53 q1 -0.8 2 0" {...sw(1.2)} />
        </g>
        {/* 몸통 — 어깨는 완만한 호로 넓고, 허리는 좁게(사선 견대·물결 밑단으로 마무리, 전폭 가로대 없이) */}
        <g style={d(1560, reduce)}>
          <path d="M96 37 q1 -7 -3 -14" {...sw(2.8)} />
          <path d="M111 37 q-1 -7 3 -14" {...sw(2.8)} />
          <path d="M93 23 q10.5 -3 21 0" {...sw(2.6)} />
        </g>
        <g style={d(1680, reduce)}>
          <path d="M95 24 l14 12" {...sw(1.6)} />
          <path d="M96 36.5 q3.5 1.8 7 0 q3.5 1.8 7.5 0" {...sw(1.4)} />
          <path d="M99.5 30 h8" {...sw(1.8)} />
        </g>
        <g style={d(1800, reduce)}>
          <path d="M101.5 29.5 q1 -0.6 2 0" {...sw(1.3)} />
          <circle cx="93" cy="55" r="0.4" {...sw(1.3, 0.5)} />
          <circle cx="87" cy="23.5" r="0.3" {...sw(1.1, 0.55)} />
        </g>
        {/* 팔 — 겉선·안선(소매 부피), 방패·창을 쥔 손까지 */}
        <g style={d(1920, reduce)}>
          <path d="M93 23 q-3 3 -4 3" {...sw(2.4)} />
          <path d="M114 23 q-1 6 -2 10" {...sw(2.4)} />
          <path d="M95 25 q-3 3 -4 3" {...sw(1.8)} />
        </g>
        <g style={d(2040, reduce)}>
          <path d="M112 24 q-1 6 -2 10" {...sw(1.8)} />
          <path d="M91.5 22 q1.5 -1 3 0" {...sw(1.6)} />
          <path d="M112 24 q1.5 -1 3 0" {...sw(1.6)} />
        </g>
        <g style={d(2160, reduce)}>
          <path d="M91 25 h2" {...sw(1.1, 0.5)} />
          <path d="M111.5 27 h2" {...sw(1.1, 0.5)} />
          <path d="M90 24.5 l1.2 -0.5" {...sw(1.2)} />
        </g>
        <g style={d(2280, reduce)}>
          <path d="M112.5 30.5 l1.2 0.5" {...sw(1.2)} />
          <path d="M97.5 17.5 q-0.5 1.5 0 3" {...sw(1.1, 0.5)} />
          <circle cx="114" cy="54.3" r="0.4" {...sw(1.3, 0.5)} />
        </g>
        <g style={d(2400, reduce)}>
          <path d="M114 52 q1 -2 2 -3" {...sw(1.1, 0.4)} />
          {/* 어깨 주름선 — 원래 y19-22(입·눈 자리)를 가로질러 얼굴이 뭉쳤다. 목깃(y30) 바로
              위 어깨 쪽으로 내린다(task#303 UAT 결함 B) */}
          <path d="M99 28 l6 -2" {...sw(1.4)} />
          <path d="M99.5 27.5 l1 -1" {...sw(1.1)} />
        </g>
        {/* 청동 창(어깨 사이에 멘, 삼상 17:6) · 칼집(삼상 17:51에서 다윗이 쓸 칼) · 겉옷 */}
        <g style={d(2520, reduce)}>
          <path d="M106.5 18.5 l1 1" {...sw(1.1)} />
          <path d="M108.5 34 v6" {...sw(1.6)} />
          <path d="M107.7 33.5 h1.6" {...sw(1.3)} />
        </g>
        <g style={d(2640, reduce)}>
          <path d="M108.5 33.5 v-1.5" {...sw(1.3)} />
          <path d="M94 23.5 q-4 8 -3 18" {...sw(1.5)} />
          <path d="M91 30 q0 4 1 8" {...sw(1.3)} />
        </g>
        <g style={d(2760, reduce)}>
          <path d="M92.5 48 l-1 2" {...sw(1.1)} />
          <path d="M94 48.5 l-0.8 1.8" {...sw(1.1)} />
          <path d="M95 24 q-2 8 -1 16" {...sw(1.2)} />
        </g>
        {/* 투구 — 볼가림·작은 깃 */}
        <g style={d(2880, reduce)}>
          <path d="M98 15.3 q5.5 -5 11 0" {...sw(2.6)} />
          <path d="M98 15.3 l-0.8 7.2" {...sw(2.2)} />
          <path d="M109 15.3 l0.8 7.2" {...sw(2.2)} />
        </g>
        <g style={d(3000, reduce)}>
          <path d="M103.5 12 q1 -1 2.5 -0.8" {...sw(1.4)} />
          {/* 코 능선 — 눈썹(y17)과 겹치지 않게 이마 안에서 짧게 끊는다(task#303 UAT 결함 B) */}
          <path d="M104.5 15.5 v1.3" {...sw(1.3)} />
          <path d="M103 23.5 q1 -0.6 2 0" {...sw(1.3)} />
        </g>
        {/* 얼굴 — 위협(눈썹을 아래로 모은다). 눈썹2+눈2+입1(상한 5) — 리뷰(task#303 S5)가 지적한
            여분 4선(눈썹 사이 호·눈 아래 가로선·입꼬리 소품 2)을 제거했다(9→5, 확대 렌더에서
            먹덩이로 뭉개졌었다). */}
        <g style={d(3120, reduce)}>
          <path d="M100 17 l3 2.3" {...sw(1.2)} />
          <path d="M107 17 l-3 2.3" {...sw(1.2)} />
        </g>
        <g style={d(3240, reduce)}>
          <path d="M100.3 20 h2" {...sw(1.2)} />
          <path d="M104.7 20 h2" {...sw(1.2)} />
        </g>
        <g style={d(3360, reduce)}>
          <path d="M100.5 22 q3 2 6 0" {...sw(1.3, 0.5)} />
        </g>
        {/* 창 — "베틀 채 같은" 자루, 철 날(삼상 17:7) */}
        <g style={d(3480, reduce)}>
          <path d="M112 54 V12" {...sw(3)} />
          <path d="M109 18 l3 -6 l3 6" {...sw(2.2)} />
          <path d="M111.5 33 h3" {...sw(1.3, 0.6)} />
        </g>
        <g style={d(3600, reduce)}>
          <path d="M90 36 q-0.5 4 0 8" {...sw(1.1, 0.4)} />
          <path d="M116 53 l0.6 -1.2 l0.6 1.2" {...sw(1.1, 0.45)} />
          <path d="M110.5 52 h3" {...sw(1.4)} />
        </g>
        {/* 방패 — 가슴 높이에 둔다(쓰러졌을 때 바퀴처럼 보이지 않도록) */}
        <g style={d(3720, reduce)}>
          <path d="M108.5 20 h5" {...sw(1.3)} />
          <circle cx="84" cy="27" r="5" {...sw(2.6)} />
          <path d="M84 22 v2" {...sw(1.2, 0.5)} />
        </g>
        <g style={d(3840, reduce)}>
          <path d="M79 27 h2" {...sw(1.2, 0.5)} />
          <circle cx="84" cy="27" r="1.3" {...sw(1.6)} />
          <circle cx="81.5" cy="24.5" r="0.35" {...sw(1.1, 0.55)} />
        </g>
        <g style={d(3960, reduce)}>
          <circle cx="86.5" cy="29.5" r="0.35" {...sw(1.1, 0.55)} />
          <path d="M81.5 25 l1 1" {...sw(1.1)} />
          <path d="M92 55 q11 2 22 0" {...sw(1.3, 0.4)} />
        </g>
        <g style={d(4080, reduce)}>
          <path d="M95 55.5 q8 1.3 16 0" {...sw(1.1, 0.35)} />
          <path d="M90 52 q1 -2 2 -3" {...sw(1.1, 0.4)} />
          <path d="M84 32 v-2" {...sw(1.2, 0.5)} />
        </g>
        <g style={d(4200, reduce)}>
          <path d="M89 24 q1 -0.6 2 0" {...sw(1.2)} />
          <path d="M111.3 50 h1.6" {...sw(1.3)} />
          <path d="M100 55.5 h6" {...sw(1.1, 0.35)} />
        </g>
        <g style={d(4320, reduce)}>
          <path d="M99.5 53.5 l0.5 -0.5" {...sw(1.1)} />
          <path d="M108 53.5 l-0.5 -0.5" {...sw(1.1)} />
          <path d="M108.5 49 h1.6" {...sw(1.1)} />
        </g>
        {/* 여기 있던 입 모양 중복선 2개(d4440·d4560)는 공식 얼굴(d3360)의 입과 같은 자리를
            덮어 뭉쳤다 — task#303 UAT 결함 B에서 제거(눈썹·눈은 그대로 둠). */}
        <g style={d(4440, reduce)}>
          <path d="M97.5 20 q0.8 -0.6 1.6 0" {...sw(1.1, 0.5)} />
          <path d="M109.5 20 q-0.8 -0.6 -1.6 0" {...sw(1.1, 0.5)} />
        </g>
        <g style={d(4560, reduce)}>
          <circle cx="104" cy="54.5" r="0.4" {...sw(1.3, 0.5)} />
          <circle cx="112.5" cy="55" r="0.35" {...sw(1.3, 0.5)} />
        </g>
        <g style={d(4680, reduce)}>
          <path d="M92 44 q-0.5 3 0 6" {...sw(1.1, 0.4)} />
          <path d="M99 48 h1" {...sw(1.1, 0.5)} />
          <path d="M107.5 48 h1" {...sw(1.1, 0.5)} />
        </g>
        {!reduce && (
          <animateTransform attributeName="transform" type="rotate"
            values="0 103 41; 5 103 41; -50 103 41" keyTimes="0; 0.22; 1"
            begin="9.55s" dur="0.7s" fill="freeze"
            calcMode="spline" keySplines="0.4 0 0.6 1; 0.55 0 0.85 0.7" />
        )}
        {!reduce && (
          <animate attributeName="opacity" from="1" to="0" begin="10.25s" dur="0.3s" fill="freeze" />
        )}
      </g>
      {/* 쓰러진 자세 — 위 회전 그룹과 달리 처음부터 "엎드러진" 모양으로 그려 방패·투구·팔다리가
          겹쳐 뭉치지 않게 한다(task#303 UAT 결함 A). 회전이 멈추는 순간(10.25s) 교체 페이드된다.
          reduce는 애니메이션이 없으므로 이 자세만 계속 보인다(위 회전 그룹은 opacity 0으로 숨김).
          삼상 17:49 "엎드러지니라" — 얼굴이 땅에 닿아 보이지 않으므로 이목구비는 그리지 않는다. */}
      <g opacity={reduce ? 1 : 0}>
        {!reduce && (
          <animate attributeName="opacity" from="0" to="1" begin="10.25s" dur="0.3s" fill="freeze" />
        )}
        {/* 무너지는 순간 — 완전히 눕히지 않는다(task#303 2차 UAT: "낮은 언덕"으로 읽힘).
            머리(79,26)가 어깨(81,36/93,30)보다 위, 어깨가 엉덩이(93,48/98,47)보다 위,
            엉덩이가 무릎(87,52.5/104,49)보다 위, 무릎이 발(81,54/110,51.5)보다 위 —
            수직 순서를 유지한 채 몸통을 45°대로 기울여 사람의 조립 단서를 살린다.
            엉덩이를 한데 모아(폭 5) 두 다리가 좌우로 벌어진 두 번째 봉우리(천막)로 안 읽히게 한다
            (task#303 3차 UAT: 대칭으로 벌어진 두 다리가 몸통과 겹쳐 산 모양으로 읽혔다).
            앞다리(서쪽, 무릎이 땅에 닿음)·뒷다리(동쪽, 짧게 뒤로 뻗음)·짚는 팔(서쪽)·늘어진 팔(동쪽). */}
        <g style={d(30, reduce)}>
          <circle cx="79" cy="26" r="4.2" {...sw(2.6)} />
          <path d="M83 26.5 l10 3.5" {...sw(2.2)} />
          <path d="M81 36 l12 -6" {...sw(2)} />
        </g>
        {/* 몸통 — 어깨(93,30/81,36 폭 13.4) → 엉덩이(98,47/93,48 폭 5.1)로 좁아진다(상자 금지) */}
        <g style={d(150, reduce)}>
          <path d="M93 30 l5 17" {...sw(2.6)} />
          <path d="M81 36 l12 12" {...sw(2.4)} />
          <path d="M80 22.3 q3.5 -1.8 6.5 0.2" {...sw(1.8)} />
        </g>
        {/* 다리 — 앞다리(무릎 땅에 닿음)·뒷다리(짧게 뒤로 뻗음), 완만한 꺾임(예각 금지) */}
        <g style={d(270, reduce)}>
          <path d="M93 48 l-6 4.5" {...sw(2.4)} />
          <path d="M87 52.5 l-6 1.5" {...sw(2.2)} />
          <path d="M98 47 l6 2" {...sw(2.4)} />
        </g>
        {/* 뒷다리 마무리 + 짚는 팔(어깨→팔꿈치→손, 두 선으로 부피) */}
        <g style={d(390, reduce)}>
          <path d="M104 49 l6 2.5" {...sw(2.2)} />
          <path d="M81 36 l-9 7" {...sw(2.4)} />
          <path d="M72 43 l-7 9" {...sw(2.2)} />
        </g>
        {/* 늘어진 반대쪽 팔(몸통과 겹치지 않게 바깥으로 벌려) + 볼가리개 */}
        <g style={d(510, reduce)}>
          <path d="M93 30 l6 2" {...sw(1.8)} />
          <path d="M99 32 l4 5" {...sw(1.6)} />
          <path d="M76.3 29.3 q0.5 1.8 0 3.4" {...sw(1.4)} />
        </g>
        {/* 창(손에서 놓여 비스듬히) · 방패(몸에서 떨어져 뒹군다) */}
        <g style={d(630, reduce)}>
          <path d="M66.5 53 l-18.5 -9" {...sw(2.2)} />
          <path d="M48 44 l-2.5 -3 M48 44 l3 -1.3" {...sw(1.8)} />
          <ellipse cx="57" cy="52.5" rx="5" ry="2" {...sw(1.8)} />
        </g>
        {/* 방패 중심쇠 · 갑주 단(짧게 — 사다리 금지) */}
        <g style={d(750, reduce)}>
          <circle cx="57" cy="52.5" r="1.1" {...sw(1.3)} />
          <circle cx="55" cy="51.5" r="0.3" {...sw(1.1, 0.5)} />
          <path d="M93 39.5 q2.5 -1.2 5 0" {...sw(1.5)} />
        </g>
        {/* 갑주 비늘 · 투구 이마 능선 */}
        <g style={d(870, reduce)}>
          <path d="M94 41.5 l1.2 0.3" {...sw(1.1)} />
          <path d="M97 42.5 l1.2 0.3" {...sw(1.1)} />
          <path d="M75.3 24 q3.7 -1.6 7.4 0" {...sw(1.3)} />
        </g>
        {/* 무릎·발 강조 */}
        <g style={d(990, reduce)}>
          <path d="M86 51.8 q1 -0.8 2 0" {...sw(1.2)} />
          <path d="M80 54.5 q1 -0.5 2 0.2" {...sw(1.2)} />
          <path d="M109.3 51 q1 -0.5 2 0.2" {...sw(1.2)} />
        </g>
        {/* 손 · 흙먼지 */}
        <g style={d(1110, reduce)}>
          <path d="M64 51.5 q1 -0.8 2 -0.3" {...sw(1.3)} />
          <path d="M102.3 37.5 q1 0.6 2 0" {...sw(1.3)} />
          <path d="M83 54 q2 1 4 0.3" {...sw(1.1, 0.5)} />
        </g>
      </g>
      {/* 다윗 — 다리(겉·안 두 선) */}
      <g style={d(4800, reduce)}>
        <path d="M23 54 l3 -7" {...sw(2.4)} />
        <path d="M35 54 l-3 -7" {...sw(2.4)} />
        <path d="M24 51 h1.2" {...sw(1.2)} />
      </g>
      <g style={d(4920, reduce)}>
        <path d="M34 51 h1.2" {...sw(1.2)} />
        <path d="M25 54 l1.6 -6" {...sw(1.6)} />
        <path d="M33 54 l-1.6 -6" {...sw(1.6)} />
      </g>
      <g style={d(5040, reduce)}>
        <path d="M22 54 h2.5" {...sw(1.4)} />
        <path d="M35.5 54 h2.5" {...sw(1.4)} />
        <path d="M22.6 53 l1.3 -1.3" {...sw(1.1)} />
      </g>
      <g style={d(5160, reduce)}>
        <path d="M36.1 53 l-1.3 -1.3" {...sw(1.1)} />
        <path d="M23 53.3 l0.6 -0.6" {...sw(1.1)} />
        <path d="M34.8 53.3 l-0.6 -0.6" {...sw(1.1)} />
      </g>
      {/* 튜닉·주름·허리끈 — 어깨는 좁고 자락은 퍼지게(사다리로 읽히지 않게 허리끈은 짧게) */}
      <g style={d(5280, reduce)}>
        <path d="M24.5 47 l2 -7 q2.5 -1.3 5 0 l2 7" {...sw(2.6)} />
        <path d="M28.2 44.2 h2.6" {...sw(1.4)} />
        <path d="M28.7 44.5 q0.6 -0.5 1.2 0" {...sw(1.2)} />
      </g>
      <g style={d(5400, reduce)}>
        <path d="M28 43 q0.5 -2 0.3 -4" {...sw(1.3, 0.6)} />
        <path d="M31 43.3 q0.3 -2 0 -4" {...sw(1.3, 0.6)} />
        <path d="M29.6 43.3 q0.4 -1.6 0.2 -3.2" {...sw(1.2)} />
      </g>
      <g style={d(5520, reduce)}>
        <path d="M29 44.3 v2" {...sw(1.1)} />
        <path d="M25.5 47 l-1 4" {...sw(1.2, 0.6)} />
        <path d="M32.5 47 l1 4" {...sw(1.2, 0.6)} />
      </g>
      <g style={d(5640, reduce)}>
        <path d="M25.8 51.3 v1" {...sw(1.1)} />
        <path d="M29 51.5 v1" {...sw(1.1)} />
        <path d="M32.2 51.3 v1" {...sw(1.1)} />
      </g>
      {/* 목자의 주머니 — 돌을 담은 자루(삼상 17:40) */}
      <g style={d(5760, reduce)}>
        <path d="M31.5 43 l3 5" {...sw(1.2)} />
        <path d="M33.5 47 q2.5 0.3 2.7 3 q-0.2 2 -2.7 1.8 q-2 -0.2 -2 -2.4 q0 -2.2 2 -2.4" {...sw(1.8)} />
        <path d="M32.8 48.5 q1 0.6 2 0" {...sw(1.2)} />
      </g>
      {/* 팔·손 — 물매 쥔 손과 지팡이 쥔 손(삼상 17:40) */}
      <g style={d(5880, reduce)}>
        <path d="M31.5 40.5 q3 -6 5.5 -11.5" {...sw(2.2)} />
        <path d="M26.5 40.5 q-2.5 3 -4.5 5.5" {...sw(2.2)} />
        <path d="M36.3 28.7 q0.9 -0.6 1.7 0.2" {...sw(1.3)} />
      </g>
      <g style={d(6000, reduce)}>
        <path d="M36.5 32 l1.3 -0.4" {...sw(1.1)} />
        <path d="M35.8 34 l1.3 -0.4" {...sw(1.1)} />
        <path d="M36.2 30.8 l1.2 -0.3" {...sw(1.1)} />
      </g>
      <g style={d(6120, reduce)}>
        <path d="M21 45.5 q-0.9 0.6 -1.8 0.3" {...sw(1.4)} />
        <path d="M20 46 v-14" {...sw(1.8)} />
        <path d="M19 33 q1 -1 2 0" {...sw(1.3)} />
      </g>
      <g style={d(6240, reduce)}>
        <path d="M37.6 29.8 l0.6 0.4" {...sw(1.2)} />
        <path d="M24.3 49 h1.6" {...sw(1.1)} />
        <path d="M35.8 49 h1.6" {...sw(1.1)} />
      </g>
      {/* 머리 — 곱슬머리 실루엣 */}
      <g style={d(6360, reduce)}>
        <circle cx="29" cy="36" r="4" {...sw(2.6)} />
        <path d="M26.5 33 q0.8 -1 1.6 0" {...sw(1.4)} />
        <path d="M28.7 32.6 q0.8 -1 1.6 0" {...sw(1.4)} />
      </g>
      <g style={d(6480, reduce)}>
        <path d="M30.8 33 q0.7 -0.9 1.4 0" {...sw(1.4)} />
        <path d="M31.5 34 q0.8 0.6 0.3 1.6" {...sw(1.3)} />
        <path d="M25.5 34.5 q0.5 -1.5 0 -3" {...sw(1.2, 0.6)} />
      </g>
      <g style={d(6600, reduce)}>
        <path d="M25.3 33.8 q3.7 -1.6 7.4 0" {...sw(1.2, 0.5)} />
        <path d="M26.9 34.1 l1.3 0.5" {...sw(1.1)} />
        <path d="M29.6 34.6 l1.3 -0.5" {...sw(1.1)} />
      </g>
      {/* 얼굴 — 결의(눈썹을 살짝 모아 집중한 표정) */}
      <g style={d(6720, reduce)}>
        <path d="M27 35.6 h1.3" {...sw(1.2)} />
        <path d="M29.7 35.6 h1.3" {...sw(1.2)} />
        <path d="M27.9 38 h2.2" {...sw(1.2)} />
      </g>
      <g style={d(6840, reduce)}>
        <path d="M26.7 35.5 l0.4 -0.3" {...sw(1.1)} />
        <path d="M29.9 35.5 l0.4 -0.3" {...sw(1.1)} />
        <path d="M28 39 q1 0.4 2 0" {...sw(1.1, 0.5)} />
      </g>
      <g style={d(6960, reduce)}>
        <path d="M27 45 q0.3 -1.3 0 -2.6" {...sw(1.2)} />
        <path d="M31.3 45 q-0.3 -1.3 0 -2.6" {...sw(1.2)} />
        <path d="M24.5 50 q0.8 -2 0.5 -4" {...sw(1.2)} />
      </g>
      <g style={d(7080, reduce)}>
        <path d="M26.3 44.5 v-1" {...sw(1.2)} />
        <path d="M28.6 39.3 q0.7 0.3 1.4 0" {...sw(1.1)} />
        <path d="M34 47.3 v1" {...sw(1.1, 0.5)} />
      </g>
      {/* 물매 — 회전 2회 뒤 투석(삼상 17:49) */}
      <g style={d(7200, reduce)}>
        <path d="M37 29 l6 -6" {...sw(1.6)} />
      </g>
      <g>
        <g style={d(7320, reduce)}>
          <circle cx="43" cy="23" r="1.9" {...sw(2)} />
        </g>
        {!reduce && (
          <g style={d(7320, false)}>
            <circle cx="43" cy="23" r="2" {...sw(2.2)}>
              <animateMotion path="M0 0 q31 -17 62 -3" begin="9.1s" dur="0.45s" fill="freeze"
                calcMode="spline" keySplines="0.3 0 0.75 1" keyTimes="0;1" />
              <animate attributeName="opacity" to="0" begin="9.55s" dur="0.15s" fill="freeze" />
            </circle>
          </g>
        )}
        {!reduce && (
          <animateTransform attributeName="transform" type="rotate"
            from="0 37 29" to="720 37 29" begin="8.6s" dur="0.5s"
            calcMode="spline" keySplines="0.35 0 0.75 1" keyTimes="0;1" />
        )}
      </g>
      <g style={d(7440, reduce)}>
        <path d="M37.8 29.8 l5.2 -5.2" {...sw(1.1, 0.6)} />
        <path d="M40 25 q1.5 -1 3 0" {...sw(1.1)} />
        <path d="M39 27.5 q1.5 -1 3 0" {...sw(1.1)} />
      </g>
      {/* 물맷돌이 이마에 박히다(삼상 17:49) — 충격 표시. 투구 개구부 위쪽으로 올려 눈썹(y17)과
          겹치지 않게 한다(task#303 UAT 결함 B — 원래 y14.9~16.5가 눈썹과 뭉쳤다). */}
      <g style={d(7560, reduce)} stroke="var(--paper-accent)">
        <path d="M103.5 14.7 l-1 -0.8" {...sw(1.4)} />
        <path d="M104.5 14.2 v-1.1" {...sw(1.4)} />
        <path d="M105.5 14.7 l1 -0.8" {...sw(1.4)} />
      </g>
      {/* 흙먼지 — 마무리 강조 */}
      <g style={d(7680, reduce)} stroke="var(--paper-accent)">
        <path d="M62 44 q-3.5 -4 -7 -4.5" {...sw(1.3)} />
        <path d="M66.5 41 q-0.5 -5 -3.5 -7.5" {...sw(1.3)} />
        <path d="M72 41.5 q3 -4.5 7 -5" {...sw(1.3)} />
      </g>
      <g style={d(7800, reduce)} stroke="var(--paper-accent)">
        <path d="M76 45 q4 -2 7.5 -1.5" {...sw(1.3)} />
        <circle cx="59" cy="39" r="0.9" {...sw(1.3)} />
        <circle cx="70" cy="36.5" r="0.9" {...sw(1.3)} />
      </g>
      <Label x="20" y="7" at="5.5" reduce={reduce}>다윗</Label><Label x="100" y="7" at="1.5" reduce={reduce}>골리앗</Label>
    </g>
  )
}
