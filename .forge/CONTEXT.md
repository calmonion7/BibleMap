...
- **관계 유형 (type)**: valence와 **직교하는 구조적 분류** — 가족·연인·친구·신하·선지자·대적·군주 등. valence가 시간에 따라 변하는 감정 성향이라면, 유형은 그 인물이 상대와 맺는 **고정된 관계 종류**다(pair 단위 1개). 뷰에서 유형별 아이콘으로 표시하고 유형끼리 모아 정렬한다.
